...
; Characteristics of each move.
	...
	move POUND,        NO_ADDITIONAL_EFFECT,        40, NORMAL,       100, 35 ; not in SWSH
	move KARATE_CHOP,  NO_ADDITIONAL_EFFECT,        50, NORMAL,       100, 25 ; not in SWSH
	move DOUBLESLAP,   TWO_TO_FIVE_ATTACKS_EFFECT,  15, NORMAL,        85, 10 ; not in SWSH
	move COMET_PUNCH,  TWO_TO_FIVE_ATTACKS_EFFECT,  18, NORMAL,        85, 15 ; not in SWSH
	...
	move RAZOR_WIND,   CHARGE_EFFECT,               80, NORMAL,       100, 10 ; not in SWSH
	...
	move JUMP_KICK,    JUMP_KICK_EFFECT,           100, FIGHTING,      95, 25 ; not in SWSH
	move ROLLING_KICK, FLINCH_SIDE_EFFECT2,         60, FIGHTING,      85, 15 ; not in SWSH
	...
	move TWINEEDLE,    TWINEEDLE_EFFECT,            25, BUG,          100, 20 ; not in SWSH
	...
	move SONICBOOM,    SPECIAL_DAMAGE_EFFECT,        1, NORMAL,        90, 20 ; not in SWSH
	...
	move LOW_KICK,     SPEED_DOWN_SIDE_EFFECT,      65, FIGHTING,     100, 20 ; Low Sweep
	...
	move DRAGON_RAGE,  SPECIAL_DAMAGE_EFFECT,        1, DRAGON,       100, 10 ; not in SWSH
	...
	move MEDITATE,     ATTACK_UP1_EFFECT,            0, PSYCHIC_TYPE, 100, 40 ; not in SWSH
	move AGILITY,      SPEED_UP2_EFFECT,             0, PSYCHIC_TYPE, 100, 30
	move QUICK_ATTACK, NO_ADDITIONAL_EFFECT,        40, NORMAL,       100, 30
	move RAGE,         RAGE_EFFECT,                 20, NORMAL,       100, 20 ; not in SWSH
	...
	move BARRAGE,      TWO_TO_FIVE_ATTACKS_EFFECT,  15, NORMAL,        85, 20 ; not in SWSH
	...
	move FLASH,        ACCURACY_DOWN1_EFFECT,        0, NORMAL,        70, 20 ; not in SWSH
	move PSYWAVE,      SPECIAL_DAMAGE_EFFECT,        1, PSYCHIC_TYPE,  80, 15 ; not in SWSH
	...
	move TRI_ATTACK,   PARALYZE_SIDE_EFFECT1,       80, NORMAL,       100, 10
